        ...
        {expanded ? (
          <div className="pt-4 h-screen flex flex-col w-16 items-center border-r-2 border-slate-800">
            <div className="text-2xl">
              <FaArrowRight className="cursor-pointer" onClick={() => setExpanded(false)} />
            </div>
          ...
          <div className="w-56 text-gray-300 pt-4 h-screen flex flex-col font-semibold shadow-lg border-r-2 border-slate-800">
            <div className="text-2xl ml-auto mr-6">
              <FaArrowLeft className="cursor-pointer" onClick={() => setExpanded(true)} />
            </div>
            <div className="flex flex-col gap-2 pt-2">
              <Link href="/" className={isActive("/") ? "bg-zinc-700 text-white" : ""}>
              ...
              <div className="mt-6">
                ...
                <ul className="pl-2 flex flex-col gap-1">
                  <Link href="/popular" className="pl-4 py-0.5 hover:bg-zinc-700 hover:text-white">
                    <li className="flex items-center">
                      <AiOutlineFire className="mr-1" />
                      Popular
                    </li>
                  </Link>
                  <Link href="/most-upvoted" className="pl-4 py-0.5 hover:bg-zinc-700 hover:text-white">
                    <li className="flex items-center">
              ...
              <div className="mt-6">
                ...
                <ul className="flex flex-col gap-1 pt-1">
                  <Link href="/bookmark" className={isActive("/bookmark") ? "pl-6 py-0.5 bg-zinc-700 text-white" : "pl-6 py-0.5 hover:bg-zinc-700 hover:text-white"}>
                    <li className="flex items-center">
                      <FaRegBookmark className="mr-1" />
                      Bookmarks
                    </li>
                  </Link>
                  <Link href="/history" className={isActive("/history") ? "pl-6 py-0.5 bg-zinc-700 text-white" : "pl-6 py-0.5 hover:bg-zinc-700 hover:text-white"}>
                    <li className="flex items-center">
                      <RiHistoryFill className="mr-1" />
                      History
                    </li>
                  </Link>
                  <Link href="/customize" className={isActive("/customize") ? "pl-6 py-0.5 bg-zinc-700 text-white" : "pl-6 py-0.5 hover:bg-zinc-700 hover:text-white"}>
                    <li className="flex items-center">
