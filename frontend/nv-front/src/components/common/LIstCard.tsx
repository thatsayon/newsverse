...
export default function LCard(post_data: any) {
    ...
    return (
        <>
            <div
                key={data.id}
                ref={cardRef}
                className="flex flex-col w-full border-slate-800 hover:border-slate-600 border shadow-lg px-4 py-3 rounded-md overflow-hidden"
            >
                {/* creator info */}
                <div>
                    <div className="flex justify-between items-center mb-1">
                        ...
                        <div className="flex items-center">
                            ...
                            >
                                {/* Icon */}
                                <div className="flex items-center bg-white text-black px-2 rounded-lg py-1">
                                    <p className="mr-2 font-semibold">Read Post</p>
                ...
                {/* image and post detail  */}
                <div className="mt-4 flex">
                    {/* image or thumbnail div  */}
                    <div className="flex w-4/12 min-w-[20rem] mr-4">
                        <a href="https://media.geeksforgeeks.org/wp-content/cdn-uploads/20221113234125/Best-Python-IDE-For-Linux-in-2023.jpg" className="flex items-center justify-center w-full h-full">
                            <img
                                src={
                                    data.thumbnail ||
                                    data.thumbnail_url ||
                    ...
                    {/* title and other info div  */}
                    <div>
                        <div className="mb-1" onClick={flipCard}>
